...
struct Spark_Connect_Expression: @unchecked Sendable {
  ...
  var lazyExpression: Spark_Connect_LazyExpression {
    get {
      if case .lazyExpression(let v)? = _storage._exprType {return v}
      return Spark_Connect_LazyExpression()
    }
    set {_uniqueStorage()._exprType = .lazyExpression(newValue)}
  }
  ...
  enum OneOf_ExprType: Equatable, Sendable {
    ...
    case lazyExpression(Spark_Connect_LazyExpression)
...
struct Spark_Connect_LazyExpression: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Spark_Connect_Expression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    21: .standard(proto: "lazy_expression"),
    22: .standard(proto: "subquery_expression"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 21: try {
          var v: Spark_Connect_LazyExpression?
          var hadOneofValue = false
          if let current = _storage._exprType {
            hadOneofValue = true
            if case .lazyExpression(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {
            if hadOneofValue {try decoder.handleConflictingOneOf()}
            _storage._exprType = .lazyExpression(v)
          }
        }()
        case 22: try {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .lazyExpression?: try {
        guard case .lazyExpression(let v)? = _storage._exprType else { preconditionFailure() }
...
extension Spark_Connect_LazyExpression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LazyExpression"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "child"),
  ]
  ...
  static func ==(lhs: Spark_Connect_LazyExpression, rhs: Spark_Connect_LazyExpression) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
