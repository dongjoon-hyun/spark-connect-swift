...
public struct org_apache_arrow_flatbuf_BodyCompression: FlatBufferObject, Verifiable {
  ...
  {
    return org_apache_arrow_flatbuf_BodyCompression(
      Table(
  ...
  public static func startBodyCompression(_ fbb: inout FlatBufferBuilder) -> UOffset {
    fbb.startTable(with: 2)
  }
  public static func add(
    codec: org_apache_arrow_flatbuf_CompressionType, _ fbb: inout FlatBufferBuilder
  ) { fbb.add(element: codec.rawValue, def: 0, at: VTOFFSET.codec.p) }
  public static func add(
    method: org_apache_arrow_flatbuf_BodyCompressionMethod, _ fbb: inout FlatBufferBuilder
  ) { fbb.add(element: method.rawValue, def: 0, at: VTOFFSET.method.p) }
  public static func endBodyCompression(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset {
...
public struct org_apache_arrow_flatbuf_RecordBatch: FlatBufferObject, Verifiable {
  ...
  public static func getRootAsRecordBatch(bb: ByteBuffer) -> org_apache_arrow_flatbuf_RecordBatch {
  ...
  public var nodesCount: Int32 {
    let o = _accessor.offset(VTOFFSET.nodes.v)
    return o == 0 ? 0 : _accessor.vector(count: o)
  }
  public func nodes(at index: Int32) -> org_apache_arrow_flatbuf_FieldNode? {
    let o = _accessor.offset(VTOFFSET.nodes.v)
    return o == 0
      ? nil
  ...
  public func mutableNodes(at index: Int32) -> org_apache_arrow_flatbuf_FieldNode_Mutable? {
    ...
    return o == 0
      ? nil
      : org_apache_arrow_flatbuf_FieldNode_Mutable(
  ...
  public var buffersCount: Int32 {
    let o = _accessor.offset(VTOFFSET.buffers.v)
    return o == 0 ? 0 : _accessor.vector(count: o)
  }
  public func buffers(at index: Int32) -> org_apache_arrow_flatbuf_Buffer? {
    let o = _accessor.offset(VTOFFSET.buffers.v)
    return o == 0
      ? nil
      : _accessor.directRead(
  ...
  public static func addVectorOf(buffers: Offset, _ fbb: inout FlatBufferBuilder) {
  ...
  public static func endRecordBatch(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset {
    let end = Offset(offset: fbb.endTable(at: start))
    return end
  }
  ...
  where T: Verifiable {
    ...
    try _v.visit(
      ...
      type: ForwardOffset<
        Vector<org_apache_arrow_flatbuf_FieldNode, org_apache_arrow_flatbuf_FieldNode>
      >.self)
    try _v.visit(
...
public struct org_apache_arrow_flatbuf_DictionaryBatch: FlatBufferObject, Verifiable {
  ...
  public static func startDictionaryBatch(_ fbb: inout FlatBufferBuilder) -> UOffset {
  ...
  public static func endDictionaryBatch(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset {
    let end = Offset(offset: fbb.endTable(at: start))
    return end
  }
...
public struct org_apache_arrow_flatbuf_Message: FlatBufferObject, Verifiable {
  ...
  public static func getRootAsMessage(bb: ByteBuffer) -> org_apache_arrow_flatbuf_Message {
    return org_apache_arrow_flatbuf_Message(
      Table(
        bb: bb, position: Int32(bb.read(def: UOffset.self, position: bb.reader)) + Int32(bb.reader))
    )
  }
  ...
  public static func add(
    headerType: org_apache_arrow_flatbuf_MessageHeader, _ fbb: inout FlatBufferBuilder
  ...
  public static func endMessage(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset {
    let end = Offset(offset: fbb.endTable(at: start))
    return end
  }
  ...
  where T: Verifiable {
    ...
    try _v.visit(
      unionKey: VTOFFSET.headerType.p, unionField: VTOFFSET.header.p, unionKeyName: "headerType",
      fieldName: "header", required: false,
      completion: { (verifier, key: org_apache_arrow_flatbuf_MessageHeader, pos) in
        switch key {
        case .none_:
        ...
        case .dictionarybatch:
          try ForwardOffset<org_apache_arrow_flatbuf_DictionaryBatch>.verify(
            &verifier, at: pos, of: org_apache_arrow_flatbuf_DictionaryBatch.self)
        case .recordbatch:
    ...
    try _v.visit(
      field: VTOFFSET.bodyLength.p, fieldName: "bodyLength", required: false, type: Int64.self)
    try _v.visit(
